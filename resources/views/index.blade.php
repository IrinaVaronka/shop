    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="http://internet-shop.tmweb.ru">Vintage-shop</a>
            </div>
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <form action="http://internet-shop.tmweb.ru/basket/add/1" method="POST">
                                    ...
                                    <input type="hidden" name="_token" value="76qWDlw6akKYI2fgyrY9TRWKpReBiDqcUFoelk7p"> </form>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <form action="http://internet-shop.tmweb.ru/basket/add/2" method="POST">
                                    <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                    <a href="http://internet-shop.tmweb.ru/mobiles/iphone_x_256" class="btn btn-default" role="button">Подробнее</a>
                                    <input type="hidden" name="_token" value="76qWDlw6akKYI2fgyrY9TRWKpReBiDqcUFoelk7p"> </form>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <form action="http://internet-shop.tmweb.ru/basket/add/5" method="POST">
                                    <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                    <a href="http://internet-shop.tmweb.ru/portable/beats_audio" class="btn btn-default" role="button">Подробнее</a>
                                    <input type="hidden" name="_token" value="76qWDlw6akKYI2fgyrY9TRWKpReBiDqcUFoelk7p"> </form>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <form action="http://internet-shop.tmweb.ru/basket/add/6" method="POST">
                                    <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                    <a href="http://internet-shop.tmweb.ru/portable/gopro" class="btn btn-default" role="button">Подробнее</a>
                                    <input type="hidden" name="_token" value="76qWDlw6akKYI2fgyrY9TRWKpReBiDqcUFoelk7p"> </form>
                            </p>
                        </div>
                    </div>
